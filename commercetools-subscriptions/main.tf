...
resource "commercetools_api_client" "integrations_client" {
  ...
  scope = ["view_products:${var.commercetools_project_key}","view_orders:${var.commercetools_project_key}","view_shopping_lists:${var.commercetools_project_key}","view_categories:${var.commercetools_project_key}","view_customers:${var.commercetools_project_key}","manage_key_value_documents:${var.commercetools_project_key}"]
}
